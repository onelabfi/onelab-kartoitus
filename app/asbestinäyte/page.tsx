      ...
      <main>
        <article style={wrap}>
          ...
          <p style={{ ...muted, fontSize: 15, lineHeight: 1.8, marginBottom: 24 }}>
            Onelabin laboratorio analysoi näytteen pyyhkäisyelektronimikroskopialla (SEM) ja alkuaine-analysaattorilla (EDS). Analyysi tunnistaa asbestimineraalit ja niiden pitoisuuden materiaalissa. Tuloksena saat kirjallisen raportin, jossa ilmoitetaan:
          </p>
